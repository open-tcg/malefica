#include <malefica/mge/math/vector_3d.hxx>

#include <catch.hpp>

TEST_CASE("testing 3d vector operations", "[math][mge]")
{
  SECTION("calculation of angle between two vectors")
  {
    mge::math::vector_3d vector_a(3, 4, 0);
    mge::math::vector_3d vector_b(4, 4, 2);

    auto angle = vector_a.angle(vector_b);
    REQUIRE(angle == Approx(0.3673).epsilon(0.001));

    vector_a = mge::math::vector_3d(1, 0, 3);
    vector_b = mge::math::vector_3d(5, 5, 0);
  ...
  {
    const mge::math::vector_3d vector_const(2, 4, 8);

    REQUIRE(vector_const.x() == 2);
    REQUIRE(vector_const.y() == 4);
    REQUIRE(vector_const.z() == 8);

    mge::math::vector_3d vector_copy{};
  ...
  {
    mge::math::vector_3d vector_a(1, 4, 8);
    mge::math::vector_3d vector_min(2, 2, 2);
    mge::math::vector_3d vector_max(6, 6, 6);

    vector_a = mge::math::clamp(vector_a, vector_min, vector_max);
  ...
  {
    mge::math::vector_3d test_vector(3, 2, 7);
    ...
    test_vector -= mge::math::vector_3d(1, 1, 3);
